...
import { usePremiumStatus } from '../../hooks/use-premium-status'; // NEW
import { PremiumDashboard } from '../../components/premium-dashboard'; // NEW
...
export default function LearnPage() {
  ...
  const mainContent = activeCourse ? (
    ...
    <div className="h-full flex flex-col p-4 md:p-8 overflow-y-auto">
      {/* 🔥 NEW: Premium Dashboard - Only shows if user is premium */}
  ...
  return (
    <>
      <LearnLayout
        ...
        onCourseAccepted={function (newCourseId: string): Promise<void> {
